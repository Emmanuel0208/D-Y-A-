...
public class EnemyAI : MonoBehaviour
{
    ...
    void UpdatePath()
    {
        ...
        // Calcular una nueva ruta desde el nodo del enemigo al nodo temporal del jugador usando el algoritmo de menor costo.
        ...
        // Conectar el nodo más cercano del jugador con el nodo temporal.
